...
export default function FuturistInvestorRelations() {
  return (
    <div className="min-h-screen flex flex-col bg-[#0B1120]">
      ...
      {/* Header - two column */}
      <section className="flex px-12 py-20">
        <div className="flex flex-col gap-4 w-[576px] shrink-0 px-12">
          <span className="text-[#00D776] font-semibold text-xs tracking-[3px] font-[Inter]">INVESTOR RELATIONS</span>
          <h1 className="text-[56px] font-bold text-white leading-[1.1]" style={{ fontFamily: "Space Grotesk" }}>Investor Relations</h1>
          <div className="w-[60px] h-1 bg-[#00D776] rounded-sm" />
        </div>
        <div className="flex flex-col justify-center gap-4 flex-1 px-6">
      ...
      {/* Ticker Banner */}
      <div className="relative h-[280px] bg-cover bg-center flex items-center px-12" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1700574005887-47134ebde2ba?w=1080&q=80')" }}>
        <div className="absolute inset-0 bg-[#00D776]/30" />
        <span className="relative z-10 text-[32px] font-bold text-white tracking-[2px]" style={{ fontFamily: "Space Grotesk" }}>NASDAQ: TVAC  ·  TVACU  ·  TVACW</span>
      </div>
      ...
      <section className="flex px-12 py-20">
        <div className="flex flex-col gap-4 w-[576px] shrink-0 px-12">
          ...
          <h2 className="text-[44px] font-bold text-white leading-[1.15]" style={{ fontFamily: "Space Grotesk" }}>Documents & Filings</h2>
        ...
        <div className="flex flex-col gap-5 flex-1 px-6">
          {documents.map((d, i) => (
      ...
      <section className="flex px-12 py-20 border-t border-[#1E293B]">
        <div className="flex flex-col gap-4 w-[576px] shrink-0 px-12">
          <span className="text-[#00D776] font-semibold text-xs tracking-[3px] font-[Inter]">MARKET DATA</span>
          <h2 className="text-[44px] font-bold text-white leading-[1.15]" style={{ fontFamily: "Space Grotesk" }}>Stock Performance</h2>
          ...
          {tickers.map((t, i) => (
            <div key={i} className="bg-[#131B2E] border border-[#1E293B] rounded-xl p-6 flex items-center justify-between">
              ...
              <div className="flex flex-col items-end gap-1">
                <span className="text-[32px] font-bold text-white" style={{ fontFamily: "Space Grotesk" }}>{t.price}</span>
