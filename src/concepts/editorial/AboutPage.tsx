...
export default function EditorialAboutPage() {
  ...
  const team = [
    { name: "Chris Hemmeter", role: "Managing Partner", photo: "/images/team/chris-hemmeter.webp", bio: "Co-founded Thayer Ventures to invest in travel and mobility technology. Previously founded iCare Marketing (acquired by Sysco) and Dynamic Payment Ventures (acquired by Elavon). Also served as CEO of CriticalArc Technologies. Cornell University graduate." },
    { name: "Tyler Carrico", role: "Managing Partner", photo: "/images/team/tyler-carrico.webp", bio: "Co-founded Derive Ventures in 2021. Spent four years at Thayer Ventures managing $50 million across 12 portfolio companies. Previously worked in tech investment banking at Bank of America Merrill Lynch. University of Virginia graduate." },
    { name: "Mike Scott", role: "Managing Partner", photo: "/images/team/mike-scott.webp", bio: "Co-founded Derive Ventures in 2021. Previously spent three years at KSL Capital Partners with over $4 billion in transaction experience across hospitality and gaming. Former real estate investment banker at J.P. Morgan. University of Michigan graduate." },
    { name: "Lee Pillsbury", role: "Co-Founder & Partner", photo: "", bio: "Spent 19 years at Marriott, rising to Executive Vice President of Lodging Strategy. Founded Thayer Lodging Group, achieving a 26.2% IRR over 25 years. Formed Thayer China in partnership with Jin Jiang Group. Cornell Hotel School graduate." },
    { name: "Mark Farrell", role: "Venture Partner", photo: "", bio: "Co-founded Thayer Ventures in 2009 and served as Managing Director overseeing all aspects of firm growth. Co-CEO and CFO of Thayer Ventures Acquisition Corporation (NASDAQ: TVAC). Former San Francisco supervisor and mayor." },
    { name: "Jeff Jackson", role: "Venture Partner", photo: "", bio: "Spent 14 years at American Airlines and served as EVP and CFO of Sabre, overseeing $8 billion in M&A activity and the company\u2019s IPO. Former board member of Travelocity, Rent-A-Center, and Getty Images. Dartmouth graduate with Northwestern Kellogg MBA." },
    { name: "David Brem", role: "Venture Partner", photo: "", bio: "Previously worked at an early-stage venture firm focused on transportation and advanced air mobility. Served as Managing Director of Michigan\u2019s flagship investment fund and in Commercial Strategy at American Airlines. Marine Corps Intelligence background. University of Michigan MBA." },
    { name: "Cara Whitehill", role: "Venture Partner", photo: "/images/team/cara-whitehill.webp", bio: "Long-time operating executive and startup advisor in travel technology. Former leader at Expedia, Travelocity, Deem, and Traxo. Active angel investor in B2B startups. Frequent speaker at PhocusWright and co-host of Travel Tech Insider podcast." },
    { name: "Chelsea Salamone", role: "Vice President", photo: "/images/team/chelsea-salamone.webp", bio: "Over a decade of hospitality expertise. Spent five years at Standard International supporting global expansion of Standard and Bunkhouse hotels. Held business development roles at Kimpton Hotels and Pyramid Hotel Group. Boston University graduate." },
  ];
