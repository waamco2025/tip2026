...
export default function EditorialAboutPage({ articles }: { articles: Article[] }) {
  ...
  const team = [
    { name: "Chris Hemmeter", role: "Managing Partner", photo: "/images/team/chris-hemmeter.webp", bio: "Chris Hemmeter co-founded Thayer Ventures and currently serves as Managing Partner. Chris pioneered \"travel-tech\" as an investment category and remains a critical thought leader, connector and ambassador for innovation across the travel industry.  Prior to Thayer Ventures, Chris founded and exited multiple venture backed businesses across hospitality and foodservice technology.  Additionally, he founded E&O Kitchen and Bar, a casual dining restaurant based in San Francisco;  The Hemmeter Collection, a direct response retailer; and founder of Hemmeter Publishing, a publisher and distributor of travel books and content. Chris holds a Bachelor of Science from Cornell University." },
    { name: "Tyler Carrico", role: "Managing Partner", photo: "/images/team/tyler-carrico.webp", bio: "Tyler Carrico currently serves as Managing Partner and focuses on investments and deployment strategy. Tyler joined Thayer in late 2017 at the launch of our first institutional fund and has played a core role in the continued growth of the Thayer platform.  In 2022, he co-founded Thayer's Derive fund strategy which served as the foundation for our horizontal investment approach. Prior to Thayer Ventures, Tyler was an investment banking professional in BoA Merril Lynch's Tech, Media and Telecom group. He graduated from the University of Virginia and holds a Bachelor of Science from the McIntire School of Commerce." },
    { name: "Mike Scott", role: "Managing Partner", photo: "/images/team/mike-scott.webp", bio: "Mike Scott currently serves as Managing Partner and focuses on investments and fund operations. Mike joined Thayer in 2021 and co-founded the Derive fund strategy.  Prior to Thayer, Mike was a private equity investment professional at KSL Capital Partners. At KSL, he had over $4bn of transaction experience covering U.S. hospitality, timeshare, all-inclusive resorts, travel distribution, gaming and alternative accommodations. Prior to KSL, Mike was an investment banking professional in J.P. Morgan's Real Estate, Gaming and Lodging group.  He graduated from the University of Michigan and holds a Bachelor of Business Administration from the Stephen M. Ross School of Business." },
    { name: "David Brem", role: "Senior Associate", photo: "/images/team/david-brem.webp", bio: "David Brem currently serves as a Venture Partner at Thayer Investment Partners. Prior to TIP, David earned his MBA from the Stephen M. Ross School of Business at the University of Michigan. During business school, David worked at an early-stage venture firm focused on investing in companies transforming transportation, logistics, and advanced air mobility. David also served as Managing Director of Michigan's flagship investment fund, where he led sourcing, diligence, and portfolio support for early-stage investments across sectors, including consumer brands and robotics. David also previously worked in Commercial Strategy at American Airlines, supporting initiatives across the carrier's hub network operations, and founded Michigan's first institutionally recognized aviation organization, engaging with industry leaders across aerospace, climate, and travel technology. Prior to business school, David worked in management consulting, where he focused on modernizing technology solutions for aerospace and aviation organizations, across both defense and commercial engagements. Prior to entering client service, David served as the Subject Matter Expert Lead for his team at the Marine Corps Intelligence Activity, where he led cyber intelligence efforts supporting national security operations in Quantico, VA. In addition to his MBA, David also holds a Bachelor's degree in Political Science from American University, and a Master's degree in Applied Intelligence with a concentration in Cyber Intelligence from Georgetown University." },
