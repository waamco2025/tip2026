    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="flex h-[560px]">
        <div className="w-[660px] shrink-0 flex flex-col justify-center gap-6 bg-[#0D2818] px-14 py-20">
          ...
          <h1 className="font-playfair text-[44px] italic font-normal text-white leading-[1.15]">Big ideas, emerging trends, and ground-breaking concepts focused on the future of travel.</h1>
        </div>
        <div className="flex-1 bg-cover bg-center" style={{ backgroundImage: "url('/images/modern-news-hero.png')" }} />
      </section>

      {/* Featured */}
      <div className="px-14 pt-8"><span className="text-[#999] font-semibold text-[11px] tracking-[2px]">FEATURED</span></div>
      <section className="flex gap-10 px-14 py-8 pb-12">
        <div className="w-[580px] h-[420px] shrink-0 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1524850301259-7729d41d11d9?w=1080&q=80')" }} />
      ...
      {/* Category Tabs */}
      <div className="flex gap-8 items-center px-14 border-b border-[#E5E5E5]">
      ...
      {/* Article Grid */}
      <section className="px-14 py-10 flex flex-col gap-6">
        {[0, 1, 2].map((row) => (
      ...
      {/* Load More */}
      <div className="flex justify-center px-14 pb-12">
